...
class RequirementAgent:
    ...
    def run(self, description: str, location: str, save_to_file: bool = False, file_name: str = "requirements_output.txt") -> str:
        try:
            final_prompt = self.prompt_template.format(description=description, location=location)
